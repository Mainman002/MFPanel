...
func selectAllPressed():
	...
	get_node("VBoxContainer/OptionsVBox/ScrollContainer/VBoxContainer/HBoxContainer/CheckVBox/Materials").pressed = true
...
func deselectPressed():
	...
	get_node("VBoxContainer/OptionsVBox/ScrollContainer/VBoxContainer/HBoxContainer/CheckVBox/Materials").pressed = false
...
func resetNamesPressed():
	...
	get_node("FileDialog").current_dir = str(MainFolderNameReset)
...
func FolderSelected():
	MainFolder = str(get_node("FileDialog").current_dir)
	CreateFolderName = MainFolder
	get_node("VBoxContainer/titleBarVBox/HBoxC1/folderName").set_text(MainFolder)
